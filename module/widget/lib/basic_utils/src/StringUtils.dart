...
class StringUtils {
  ...
  static String unsigned(String value) {
    try {
      final diacriticsMap = Diacritics().map;

      return value.splitMapJoin(
        '',
        onNonMatch: (char) => diacriticsMap.containsKey(char) ? diacriticsMap[char] : char,
      );
    } catch (e) {
      return value;
    }
  ...
  static String randomizer(
      bool alphabet, bool numeric, bool lowercase, bool uppercase, bool special, String from) {
