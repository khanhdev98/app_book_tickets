...
class RegexPattern {
  ...
  static String specialCharacterHotel = "[\$&+,:;=?@#|'<>.^*()%!/_{}\"`~\\[\\]-]";

  static String phoneTemp = r'(\+[0-9]+[\- \.]*)?(\([0-9]+\)[\- \.]*)?([0-9][0-9\- \.]+[0-9])';
  ...
  static String googlePatternEmail = r'[a-zA-Z0-9\+\.\_\%\-\+]{1,256}\@[a-zA-Z0-9][a-zA-Z0-9\-]{0,64}(\.[a-zA-Z0-9][a-zA-Z0-9\-]{0,25})';
  /// URL regex
  /// Eg:
  ...
  static String lookLikePhone = r'(\+[0-9]+[\- \.]*)?(\([0-9]+\)[\- \.]*)?([0-9][0-9\- \.]+[0-9])$';
