...
extension GroupByExtensionOptional<T> on Iterable<T>? {
  GroupByIterable<T, TKey>? groupBy<TKey>(
    ...
    return groupBy(keySelector, keyComparer: keyComparer);
  }
...
extension Iterables<E> on Iterable<E> {
  Map<K, List<E>> groupByToMap<K>(K Function(E) keyFunction) => fold(
      <K, List<E>>{},
...
extension GroupByExtension<T> on Iterable<T> {
  ...
  /// [hasher] properties in a_order to determine equivalency. If omitted,
