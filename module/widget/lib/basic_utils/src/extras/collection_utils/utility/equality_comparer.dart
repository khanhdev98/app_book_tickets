...
/// Takes two values of type `T` and computes their sort a_order, represented by
...
/// ```
///
/// The [EqualityComparer.sort] field tests for sorting a_order. Two elements of a
/// given type are passed to the function, and the function returns an integer
/// that represents the sorting a_order of the elements. If the left value is lesser
